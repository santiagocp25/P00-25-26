...
def calcular_area_circulo(radio: float) -> float:
    ...
    # parametro radio: Radio del círculo (float)
...
def programa_principal() -> None:
    ...
    if figura_elegida == "R":
        ...
        print(f"El área del rectángulo con base {base_rectangulo} y altura {altura_rectangulo} " f"es: {area_rectangulo:.2f}" )
        ...
        print(f"El área del círculo con radio {radio_circulo} " f"es: {area_circulo:.2f}" )
