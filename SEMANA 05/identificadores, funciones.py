...
def programa_principal() -> None:
    ...
    figura_elegida: str = input(
        "Ingresa 'R' para rectángulo o 'C' para círculo: "
    ).upper().strip()
    ...
    if figura_elegida == "R":
        ...
        area_rectangulo: float = calcular_area_rectangulo(
            base_rectangulo, altura_rectangulo
        )

        print(
            f"El área del rectángulo con base {base_rectangulo} y altura {altura_rectangulo} "
        ...
        print(
            f"El área del círculo con radio {radio_circulo} "
